# -*- coding: utf-8 -*-
"""
Created on Sun Aug 28 10:43:43 2022
...
class Sentence():
    ...
    def parenthesize(cls, s):
        """Parenthesizes ana expression if not already parentesized"""
...
def model_check(knowledge, query):
    ...
    def check_all(knowledge, query, symbols, model):
        ...
        if not symbols:
            ...
            #choose onr if the remaining unused symbols
    ...
    #get all symbols in bith knowledge and query
    symbols = set.union(knowledge.symbols(), query.symbols())
    
    #check that knowledge entail query
